...
void loadObjects(int argc, char *argv[])
{
    ...
    cerr << endl
         << "Curve Mode: \tC" << endl;
    cerr << "Surface Mode: \tS" << endl;
    cerr << "Point Mode: \tP" << endl;
    cerr << "*** loading and constructing curves and surfaces ***" << endl;
...
GLFWwindow *createOpenGLWindow(int width, int height, const char *title)
{
    ...
    cout << "Running OpenGL " << major << minor << endl;
...
int main(int argc, char **argv)
{
    ...
    program_light = Utils::createShaderProgram("./shaders/main.vert", "./shaders/light.frag");
    program_color = Utils::createShaderProgram("./shaders/main.vert", "./shaders/color.frag");
